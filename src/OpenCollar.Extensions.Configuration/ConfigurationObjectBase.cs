...
namespace OpenCollar.Extensions.Configuration
{
    ...
    ///         <see cref="Microsoft.Extensions.Configuration.IConfigurationSection"/> or <see cref="Microsoft.Extensions.Configuration.IConfigurationRoot"/>
    ///         .
    ///     </para>
    ///     <para>
    ///         The <see cref="System.ComponentModel.INotifyPropertyChanged"/> interface is supported allowing changes to be detected and reported from both
    ///         the underlying configuration source (through the source changed event) and from detected changes made to properties with a setter.  Only
    ///         material changes are reported, and change with no practical impact (for example assigning a new instance of a string with the same value)
    ...
    internal abstract class ConfigurationObjectBase : IConfigurationObject
    {
        ...
        /// <summary>Returns the default value for the type specified.</summary>
