...
namespace OpenCollar.Extensions.Configuration.Collections
{
    ...
    [DebuggerDisplay("ReadOnlyConfigurationDictionary<{typeof(TElement).Name,nq}>[{Count}] ({CalculatePath()})")]
    internal sealed class ReadOnlyConfigurationDictionary<TElement> : ConfigurationDictionary<TElement>, IReadOnlyDictionary<string, TElement>
    {
        ...
        /// <summary> Gets an <see cref="ICollection{TElement}"/> containing the keys of the <see cref="IDictionary{T,T}"/>. </summary>
        IEnumerable<string> IReadOnlyDictionary<string, TElement>.Keys => Keys;

        /// <summary> Gets an <see cref="ICollection{TElement}"/> containing the values in the <see cref="IDictionary{T,T}"/>. </summary>
