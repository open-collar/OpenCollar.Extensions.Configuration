...
namespace OpenCollar.Extensions.Configuration.Collections
{
    ...
    [DebuggerDisplay("ConfigurationDictionary<{typeof(TElement).Name,nq}>[{Count}] ({CalculatePath()})")]
    internal class ConfigurationDictionary<TElement> : ConfigurationDictionaryBase<string, TElement>, IConfigurationDictionary<TElement>
    {
        ...
        /// <summary>
        ///     Copies the elements of the <see cref="ICollection{T}"/> to an <see cref="System.Array"/>, starting at a particular
        ///     <see cref="System.Array"/> index.
        /// </summary>
        /// <param name="array">
        ///     The one-dimensional <see cref="System.Array"/> that is the destination of the elements copied from <see cref="ICollection{T}"/>. The
        ...
        /// <summary> Determines whether this instance contains the object given. </summary>
        /// <param name="item"> The object to locate in the <see cref="ICollection{TElement}"/>. </param>
        /// <returns> <see langword="true"/> if <paramref name="item"/> is found in the <see cref="ICollection{TElement}"/>; otherwise, <see langword="false"/>. </returns>
        ...
        /// <summary> Adds the specified element to the dictionary, using the name of the object as a the key. </summary>
        /// <param name="key"> The key identifying the value to add.. </param>
