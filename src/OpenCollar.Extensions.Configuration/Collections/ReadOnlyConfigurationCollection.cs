...
namespace OpenCollar.Extensions.Configuration.Collections
{
    ...
    internal sealed class ReadOnlyConfigurationCollection<TElement> : ConfigurationDictionaryBase<int, TElement>, IReadOnlyConfigurationCollection<TElement>
    {
        ...
        ///     The settings used to control how configuration objects are created and the features they support.
        /// </param>
        public ReadOnlyConfigurationCollection(IConfigurationParent? parent, IPropertyDef propertyDef, IConfigurationRoot configurationRoot, ConfigurationObjectSettings settings,
        ...
        /// </summary>
        /// <value>
        ///     The value of the item to get or set.
        /// </value>
        /// <param name="index">
        ///     The index of the item in the collection.
        /// </param>
        /// <returns>
        ///     The item specified by <paramref name="index" />.
        /// </returns>
