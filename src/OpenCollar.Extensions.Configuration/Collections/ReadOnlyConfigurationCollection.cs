...
{
    /// <summary> A read-only collection of <see cref="IConfigurationObject"> configuration objects </see> that notifies when an element is added or removed. </summary>
    /// <typeparam name="TElement"> The type of the element. </typeparam>
    [DebuggerDisplay("ReadOnlyConfigurationCollection<{typeof(TElement).Name,nq}>[{Count}] ({CalculatePath()})")]
