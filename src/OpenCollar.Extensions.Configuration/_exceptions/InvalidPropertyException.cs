...
{
    /// <summary> An exception thrown when a property is incorrectly defined.. </summary>
    /// <seealso cref="Exception"/>
    [Serializable]
    public class InvalidPropertyException : Exception
    {
        /// <summary> Initializes a new instance of the <see cref="InvalidPropertyException"/> class. </summary>
        ...
        /// <summary> Gets or sets the property name and parent type name of the property affected. </summary>
