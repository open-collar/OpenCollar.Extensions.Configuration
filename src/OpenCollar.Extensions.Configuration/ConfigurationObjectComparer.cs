...
{
    /// <summary> A comparer for objects that implement interfaces derived from <see cref="IConfigurationObject"/>. </summary>
    /// <seealso cref="IEqualityComparer{T}"/>
    public class ConfigurationObjectComparer : IEqualityComparer<IConfigurationObject>
    {
        /// <summary> Prevents a default instance of the <see cref="ConfigurationObjectComparer"/> class from being created. </summary>
        private ConfigurationObjectComparer()
        {
        }

        /// <summary> Gets an instance of the comparer </summary>
        ...
        /// <summary>
        ///     Gets a distinct list of the definitions of properties defined in interfaces derived from <see cref="IConfigurationObject"/> by the type
        ///     given.
        /// </summary>
        /// <param name="type"> The type for which to retrieve the properties. </param>
        /// <returns> The distinct list of the definitions of properties defined in interfaces derived from <see cref="IConfigurationObject"/> by the type given. </returns>
        ...
        /// <summary> Gets the interfaces derived from <see cref="IConfigurationObject"/>. </summary>
        ...
        /// <summary> Gets the relevant properties from the type given. </summary>
