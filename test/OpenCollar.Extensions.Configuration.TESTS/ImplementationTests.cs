...
namespace OpenCollar.Extensions.Configuration.TESTS
{
    public sealed class ImplementationTests
    {
        ...
        public void TestConstructor()
        {
            ...
            x = new Implementation(typeof(IConfigurationCollection<IChildElement>), false);
            ...
            x = new Implementation(typeof(IConfigurationCollection<IChildElement>), true);
            ...
            x = new Implementation(typeof(IConfigurationDictionary<IChildElement>), false);
            ...
            x = new Implementation(typeof(IConfigurationDictionary<IChildElement>), true);
            ...
            x = new Implementation(typeof(IRootElement), false);
