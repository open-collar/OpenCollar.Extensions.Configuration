...
namespace OpenCollar.Extensions.Configuration.TESTS
{
    public sealed class PropertyDefTests : IClassFixture<TestDataFixture>
    {
        ...
        {
            var propertyDef =
            new PropertyDef(typeof(IRootElement).GetProperty(nameof(IRootElement.DateTimeOffsetPropertyA), BindingFlags.Instance | BindingFlags.Public), new ConfigurationObjectSettings());
        ...
        {
            var propertyDef =
            new PropertyDef(typeof(IRootElement).GetProperty(nameof(IRootElement.DoublePropertyA), BindingFlags.Instance | BindingFlags.Public), new ConfigurationObjectSettings());
        ...
        {
            var propertyDef =
            new PropertyDef(typeof(IRootElement).GetProperty(nameof(IRootElement.Int16PropertyA), BindingFlags.Instance | BindingFlags.Public), new ConfigurationObjectSettings());
        ...
        {
            var propertyDef =
            new PropertyDef(typeof(IRootElement).GetProperty(nameof(IRootElement.Int32PropertyA), BindingFlags.Instance | BindingFlags.Public), new ConfigurationObjectSettings());
        ...
        {
            var propertyDef =
            new PropertyDef(typeof(IRootElement).GetProperty(nameof(IRootElement.SBytePropertyA), BindingFlags.Instance | BindingFlags.Public), new ConfigurationObjectSettings());
        ...
        public void TestIsReadOnly()
        {
            ...
            propertyDef = new PropertyDef(typeof(IRootElement).GetProperty(nameof(IRootElement.BooleanPropertyB), BindingFlags.Instance | BindingFlags.Public), new ConfigurationObjectSettings());
