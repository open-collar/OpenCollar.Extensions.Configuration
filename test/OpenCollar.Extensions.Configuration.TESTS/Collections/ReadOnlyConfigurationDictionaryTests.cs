...
namespace OpenCollar.Extensions.Configuration.TESTS.Collections
{
    ...
    public sealed class ReadOnlyConfigurationDictionaryTests : IClassFixture<TestDataFixture>
    {
        ...
        public void AddAndRetrieveTests()
        {
            ...
            var x = new ReadOnlyConfigurationDictionary<IChildElement>(testContext.PropertyDef, testContext.Configuration.ConfigurationRoot, Get("a", a), Get("b", b), Get("c", c));
        ...
        public void ClearTests()
        {
            ...
            var x = new ReadOnlyConfigurationDictionary<IChildElement>(testContext.PropertyDef, testContext.Configuration.ConfigurationRoot, Get("a", a), Get("b", b), Get("c", c), Get("d", d));
        ...
        public void ContainsTests()
        {
            ...
            var x = new ReadOnlyConfigurationDictionary<IChildElement>(testContext.PropertyDef, testContext.Configuration.ConfigurationRoot, Get("a", a), Get("b", b));
        ...
        public void IsDirtyTests()
        {
            ...
            x = new ReadOnlyConfigurationDictionary<IChildElement>(testContext.PropertyDef, testContext.Configuration.ConfigurationRoot, Get("a", a), Get("b", b), Get("c", c), Get("e", e));
        ...
        public void TestConstructor()
        {
            ...
            var x = new ReadOnlyConfigurationDictionary<IChildElement>(propertyDef, testContext.Configuration.ConfigurationRoot);

            Assert.NotNull(x);
            Assert.Equal(0, x.Count);
            Assert.Equal(propertyDef.PropertyName, x.PropertyDef.PropertyName);

            x = new ReadOnlyConfigurationDictionary<IChildElement>(propertyDef, testContext.Configuration.ConfigurationRoot, (IEnumerable<KeyValuePair<string, IChildElement>>?)null);
            ...
            x = new ReadOnlyConfigurationDictionary<IChildElement>(propertyDef, testContext.Configuration.ConfigurationRoot, Get("a", a), Get("b", b));

            Assert.NotNull(x);
            Assert.Equal(2, x.Count);
            Assert.Equal(propertyDef.PropertyName, x.PropertyDef.PropertyName);

            x = new ReadOnlyConfigurationDictionary<IChildElement>(propertyDef, testContext.Configuration.ConfigurationRoot, (IEnumerable<KeyValuePair<string, IChildElement>>)(new[] { Get("a", a), Get("b", b) }));
        ...
        public void ValuesTests()
        {
            ...
            var x = new ReadOnlyConfigurationDictionary<IChildElement>(testContext.PropertyDef, testContext.Configuration.ConfigurationRoot, Get("a", a), Get("a", b), Get("c", c));
